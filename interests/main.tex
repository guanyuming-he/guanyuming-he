...
only technical tools, but a possible solution for addressing one of the deepest
...
forcing them to target individuals rather than populations. For example, if
breaking one person’s encryption, on average, required even a single day of
