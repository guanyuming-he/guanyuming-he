...
A good starting point is probably Cantor's work on his theory of abstract sets,
...
\end{CT}
\begin{proof}
When $S$ is empty, it is trival that there's no bijection between $\emptyset$
and $\{\emptyset\}$. Then we consider when $S$ is not empty.

Suppose for the sake of contradiction that there exists a bijection $f : S \to
\mathcal{P}(S)$. The existence of this $f$ enables us to apply Cantor's
...
Because $f$ is a bijection, there is such $s_0$ that $f(s_0) = T$. Now we ask
