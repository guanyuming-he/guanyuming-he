...
prominent example is the continuous push for exceptional access to people's
...
divisions of its address space and delegation of most routing responsibilities
to each individual networks (e.g.\ ISPs). Its BGP, opearing in between them, is
